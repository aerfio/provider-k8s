...
import (
	...
	"github.com/crossplane/provider-lambda/apis/v1alpha1"
...
func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Lambda support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add Lambda APIs to scheme")
	...
	kingpin.FatalIfError(lambda.Setup(mgr, o), "Cannot setup Lambda controllers")
