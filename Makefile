# ====================================================================================
# Setup Project
PROJECT_NAME := provider-lambda
PROJECT_REPO := github.com/aerfio/$(PROJECT_NAME)
...
XPKGS = provider-lambda
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-lambda: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Lambda CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Lambda controllers
...
# This target prepares repo for your provider by replacing all "lambda"
